...
const transaction = (projectId: string, transactionId: string) =>
  `/projects/${encodeURIComponent(projectId)}/transactions/${encodeURIComponent(
    transactionId,
  )}`;
...
export function getActiveTransaction(
  ...
  return creatorRequest(
    `/projects/${encodeURIComponent(projectId)}/transactions/active`,
  );
}
...
export async function getReviewManifest(
  projectId: string,
  transactionId: string,
...
export function decideReviewGroup(
  ...
  return creatorRequest(
    `${transaction(
      projectId,
      transactionId,
    )}/review/groups/${encodeURIComponent(groupId)}/decision`,
    {
      method: "PUT",
...
export function commentOnReviewGroup(
  ...
  return creatorRequest(
    `${transaction(
      projectId,
      transactionId,
    )}/review/groups/${encodeURIComponent(groupId)}/comments`,
    {
      method: "POST",
...
export function listExecutionAuthorizations(
  ...
  return creatorRequest(
    `${transaction(
      projectId,
      transactionId,
    )}/execution-authorizations?status=${status}`,
  );
}
...
export function getExecutionAuthorization(
  ...
  return creatorRequest(
    `${transaction(
      projectId,
      transactionId,
    )}/execution-authorizations/${encodeURIComponent(authorizationId)}`,
  );
}
...
export function approveExecutionAuthorization(
  ...
  return creatorRequest(
    `${transaction(
      projectId,
      transactionId,
    )}/execution-authorizations/${encodeURIComponent(authorizationId)}/approve`,
    {
      method: "POST",
      headers: { "Idempotency-Key": clientRequestId },
      body: jsonBody(request),
...
export function declineExecutionAuthorization(
  ...
  return creatorRequest(
    `${transaction(
      projectId,
      transactionId,
    )}/execution-authorizations/${encodeURIComponent(authorizationId)}/decline`,
    {
      method: "POST",
      headers: { "Idempotency-Key": clientRequestId },
      body: jsonBody(request),
