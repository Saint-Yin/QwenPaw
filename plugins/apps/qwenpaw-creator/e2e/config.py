...
R2V_PROJECT_ID = os.getenv(
    "CREATOR_E2E_R2V_PROJECT_ID",
    "creator-974986b728b6",
)
...
EDIT_PROJECT_ID = os.getenv(
    "CREATOR_E2E_EDIT_PROJECT_ID",
    "creator-b2b3414f6fc8",
)
EDIT_UNIT_ID = os.getenv("CREATOR_E2E_EDIT_UNIT_ID", "edit-e2e-long-highlight")
ASSET_PROJECT_ID = os.getenv(
    "CREATOR_E2E_ASSET_PROJECT_ID",
    "creator-023d115f301a",
)
...
PENDING_TRANSACTION_ID = os.getenv(
    "CREATOR_E2E_PENDING_TRANSACTION_ID",
    "",
).strip()
...
PENDING_SNAPSHOT_ROOT = os.getenv(
    "CREATOR_E2E_PENDING_SNAPSHOT_ROOT",
    "",
).strip()
RUN_PROVIDER_SEALING = (
    os.getenv("CREATOR_E2E_RUN_PROVIDER_SEALING", "0") == "1"
)
...
LATE_MEDIA_PROJECT_ID = os.getenv(
    "CREATOR_E2E_LATE_MEDIA_PROJECT_ID",
    "",
).strip()
