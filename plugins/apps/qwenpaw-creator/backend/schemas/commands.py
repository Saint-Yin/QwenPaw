...
class CreatorCommandRequest(StrictModel):
    ...
    expected_target_versions: list[ExpectedTargetVersion] = Field(
        default_factory=list,
        alias="expectedTargetVersions",
    )
    expected_presentation_version: str | None = Field(
        None,
        alias="expectedPresentationVersion",
    )
    expected_decision_token: str | None = Field(
        None,
        alias="expectedDecisionToken",
    )
    expected_overlay_head: str | None = Field(
        None,
        alias="expectedOverlayHead",
    )
