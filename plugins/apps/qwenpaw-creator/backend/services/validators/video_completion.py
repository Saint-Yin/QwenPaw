# -*- coding: utf-8 -*-
# flake8: noqa: E501
# pylint: disable=too-many-boolean-expressions,unnecessary-comprehension
...
def validate_video_project_completion(
    *,
    ...
    completed_sections: list[
        tuple[ParsedSection, str, Mapping[str, Any], str]
    ] = []
    ...
    for section in nonempty:
        ...
        if row is not None and not any(
            ...
            completed_sections.append(
                (section, rendered_ref, row, identity[1]),
            )
