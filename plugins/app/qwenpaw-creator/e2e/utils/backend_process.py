...
class ExternalCreatorBackend:
    ...
    def __init__(
        ...
        *,
        ...
        self.entrypoint = entrypoint.resolve() if entrypoint is not None else None
    ...
    def health_url(self) -> str:
        return f"{self.origin}/api/creator/health"
    ...
    def start(self, *, timeout: float = 120) -> None:
        ...
        while time.monotonic() < deadline:
            ...
            try:
                ...
                if response.status_code == 200 and payload.get("status") == "ok" and (
                ...
                pass
            time.sleep(0.1)
        raise AssertionError("Creator backend did not become healthy:\n" + self.log_tail())
