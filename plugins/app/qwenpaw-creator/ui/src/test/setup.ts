...
(globalThis as unknown as { EventSource: typeof TestEventSource }).EventSource = TestEventSource;
(globalThis as unknown as { __testEventSources: typeof TestEventSource.instances }).__testEventSources = TestEventSource.instances;
