...
export type CreatorPanel = 'plan' | 'workbench' | 'assets' | 'compose' | 'other';
...
export const useCreatorInteractionStore = create<CreatorInteractionState>((set) => ({
  panel: 'other',
  selectedRef: null,
  editingField: null,
  selection: null,
  ...
  reset: () => set({ panel: 'other', selectedRef: null, editingField: null, selection: null, extraRefs: [] }),
}));
