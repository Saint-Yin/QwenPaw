...
export type CreatorContentPart =
  ...
  | { type: 'image_url'; image_url: { url: string }; attachment?: { assetVersionRef?: string; mediaType?: string } }
  | { type: 'video_url'; video_url: { url: string }; fps?: number; max_frames?: number; attachment?: { assetVersionRef?: string; mediaType?: string } }
