...
export type AssetPreviewState = 'planned' | 'processing' | 'ready' | 'failed' | 'unavailable';

function placeholderLabel(state: AssetPreviewState, loadFailed: boolean): string {
...
export default function AssetMediaPreview({
  ...
  return (
    <span data-asset-preview-state={loadFailed ? 'unavailable' : state} className={placeholderClassName}>
