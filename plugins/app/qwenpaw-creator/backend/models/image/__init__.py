...
def get_image_backend() -> str:
    ...
    """
    tool_cfg = model_config.get_request_tool_config(model_config.CREATOR_IMAGE_CONFIG_TOOL)
...
async def generate_image(
    ...
    return await model.generate(
        prompt, aspect_ratio=aspect_ratio, reference_image_urls=reference_image_urls
    )
