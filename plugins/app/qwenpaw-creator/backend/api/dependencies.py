...
async def bind_creator_trace_request(request: Request, response: Response) -> AsyncIterator[None]:
...
async def creator_error_handler(_request: Request, error: CreatorError) -> JSONResponse:
    return JSONResponse(
