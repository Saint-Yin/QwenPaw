...
def test_generic_qwen_image_env_selects_dashscope_and_is_consumed(monkeypatch) -> None:
    ...
    try:
        ...
        assert provider.generation_url.endswith("/multimodal-generation/generation")
    finally:
