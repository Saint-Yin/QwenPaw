...
def test_runtime_path_segment_rejects_traversal_and_control_characters() -> None:
    assert require_safe_runtime_segment("review-1:decision.2") == "review-1:decision.2"
