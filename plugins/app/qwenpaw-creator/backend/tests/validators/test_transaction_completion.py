...
from services.validators.transaction import CompletionSnapshot, validate_completion
...
def test_completion_transaction_checks_are_disabled() -> None:
    broken = replace(
        ...
        consistency_report_working_head="head-4",
        domain_reports=(ValidationReport((ValidationIssue("R2V_STORYBOARD_REQUIRED", "missing"),)),),
