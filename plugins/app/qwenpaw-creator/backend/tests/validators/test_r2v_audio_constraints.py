...
def test_split_long_shot_falls_back_to_equal_split_without_action_timeline() -> None:
...
def test_parse_action_time_handles_strings_numbers_and_invalid_ranges() -> None:
