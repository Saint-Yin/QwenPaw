...
def projection_fixture() -> ProjectionFixture:
    ...
    ai_edit_envelope: dict[str, Any] = {
        ...
        "plan": {
            ...
            "storyboard": [{"start": 25.3, "end": 31.8, "image_url": "/frames/clip-01.jpg"}],
            "audio_plan": {"preserve_original": True},
            "storyboard_image_url": "/generated/edit-preview/u-edit-board-v2.png",
        },
        "storyboard_image_url": "/generated/edit-preview/u-edit-board-v2.png",
        "material_assets": [{"asset_id": "upload-video-01", "duration": 93.125}],
    ...
    catalogs = ProjectionCatalogs(assets=tuple(assets.values()), artifacts=tuple(artifacts.values()))
    selections = RevisionSelections(
        revision_id="revision-17",
        artifact_versions={
    ...
    return ProjectionFixture(snapshot, catalogs, selections, provider, ai_edit_plan, artifacts, assets)
