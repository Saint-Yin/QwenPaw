...
from services.project_files.serialization import CanonicalJsonError, load_project_json


def _raw_project() -> dict:
    return Project.new(project_id="project-1", name="Project").model_dump(mode="json")
