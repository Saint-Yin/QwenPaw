...
from services.specialists.tool_manifest import FILE_TOOL_SCHEMAS, provider_function
...
def creator_tool_manifest() -> tuple[dict[str, Any], ...]:
    ...
    definitions: dict[str, dict[str, Any]] = {
        **{name: deepcopy(FILE_TOOL_SCHEMAS[name]) for name in READ_FILE_TOOLS + WRITE_FILE_TOOLS},
