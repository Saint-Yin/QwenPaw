...
from .models import AgentRunStatus, CreatorAgentRunRecord, TERMINAL_AGENT_RUN_STATUSES
...
class CreatorAgentRunStore:
    ...
    def create(
        self, record: CreatorAgentRunRecord | Mapping[str, Any]
        ...
        with self._project_lock(project_id):
            ...
            for path in root.glob("*.json"):
                if path.is_symlink() or not path.is_file():
                    raise AgentRunStoreError("Agent run must be a regular file")
    ...
    def transition(
        ...
        run_id: str,
        *,
        expected_status: AgentRunStatus | str | Collection[AgentRunStatus | str],
    ...
    def _require_project(self, project_id: str) -> None:
        ...
        try:
            ...
            raise AgentRunStoreError(f"Project does not exist: {project_id}") from exc
